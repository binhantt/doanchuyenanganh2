  ...
  const decorations = [
    {
      ...
      description:
        'Thiết kế và trang trí không gian tiệc cưới sang trọng, lãng mạn với phong cách độc đáo, phù hợp với chủ đề và sở thích của bạn.',
      theme: 'Romantic',
      style: 'Sang trọng',
      base_price: 15000000,
      is_active: true,
    ...
    },
    {
      ...
      description:
        'Phong cách vintage cổ điển, mang đến không gian ấm cúng và đầy hoài niệm cho ngày trọng đại của bạn.',
      theme: 'Vintage',
      style: 'Cổ điển',
      base_price: 12000000,
      is_active: true,
    ...
    },
    {
      ...
      description:
        'Phong cách hiện đại, tối giản nhưng vẫn sang trọng và ấn tượng với những đường nét tinh tế.',
      theme: 'Modern',
      style: 'Hiện đại',
      base_price: 18000000,
      is_active: true,
    ...
    },
    {
      ...
      description:
        'Phong cách vườn xanh mát mẻ, gần gũi với thiên nhiên, tạo không gian thư giãn và thoải mái.',
      theme: 'Garden',
      style: 'Thiên nhiên',
      base_price: 14000000,
      is_active: true,
    ...
    },
    {
      ...
      description:
        'Phong cách xa hoa, đẳng cấp với những chi tiết trang trí cao cấp nhất, phù hợp cho tiệc cưới quy mô lớn.',
      theme: 'Luxury',
      style: 'Xa hoa',
      base_price: 25000000,
      is_active: true,
