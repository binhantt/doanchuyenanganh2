...
export async function seed(knex: Knex): Promise<void> {
  ...
  const packages = [
    ...
    },
    {
      ...
      slug: 'goi-premium',
      description:
        'Gói Premium mang đến trải nghiệm đám cưới hoàn hảo với đầy đủ các dịch vụ cao cấp. Từ trang trí sang trọng, chụp ảnh quay phim chuyên nghiệp đến wedding planner tận tâm, chúng tôi đảm bảo mọi khoảnh khắc đều trọn vẹn.',
      price: 100000000,
      is_popular: true,
      is_active: true,
      features: {
