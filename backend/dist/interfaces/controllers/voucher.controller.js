...
class VoucherController {
        ...
        try {
            ...
            if (!voucher.canBeUsedForOrder(orderAmount)) {
                ...
                if (!voucher.isActive) {
                    ...
                    message = `Đơn hàng phải tối thiểu ${new Intl.NumberFormat('vi-VN').format(voucher.minOrderValue)} VNĐ`;
                }
                res.json({
                    success: true,
                    data: {
    ...
    async createVoucher(req, res) {
        try {
            const { code, title, description, discountType, discountValue, maxDiscount, minOrderAmount, startDate, endDate, isActive, } = req.body;
